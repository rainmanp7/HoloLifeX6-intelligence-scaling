...
function calculate_evolution_metrics_detailed(graph::Any, performance::Dict)::Dict
    ...
    # Calculate complexity balance with detailed distribution
    ...
    reasoning["complexity_distribution"] = Dict(
        ...
        "most_complex_module" => most_complex_module,
        "least_complex_module" => least_complex_module
    )
    ...
    return Dict(
        ...
        "most_complex_module" => most_complex_module,
        "least_complex_module" => least_complex_module,
        "max_complexity" => isempty(complexities) ? 0.0 : maximum(complexities),
        "min_complexity" => isempty(complexities) ? 0.0 : minimum(complexities),
        "reasoning" => reasoning
    )
end
